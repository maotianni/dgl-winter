...
if __name__ == '__main__':
    ...
    argparser.add_argument('--in-feat-t', type=int, default=100, help='time embedding feats')
    argparser.add_argument('--in-feat-s', type=int, default=100, help='memory feats')
